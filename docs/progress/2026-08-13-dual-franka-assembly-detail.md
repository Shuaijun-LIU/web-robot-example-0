...
- Assembly1 now includes:
  ...
  - a free claw hammer rebuilt around a longitudinal handle and transverse steel head, with the round striking face opposite a flat, tapered two-tine nail-pulling claw.
...
- Assembly1: 66 bodies, 412 geoms, 32 actuators, 106 qpos.
...
- The Assembly1 hammer is staged at the requested 180-degree orientation. Its former tubular capsule tines were replaced by flat tapered claw plates with a widening nail-pulling slot and only slight downward rake.
...
- Updated offline MuJoCo compilation: Assembly1 has 66 bodies / 412 geoms; Assembly2 has 66 bodies / 400 geoms. Both retain 32 actuators and 106 qpos.
...
- The application entry selection now defaults to `Franka Assembly1`; a fresh browser load reported `sceneKey=frankaAssembly1`, four physical instances, and 66 bodies.
